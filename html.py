...
class html(wx.Frame):
	def __init__(self):
		...
		self.Show()
	def onb(self,event):
		titles = wx.GetTextFromUser("write the title","html")
...
""")
	def onhh(self,event):
		h1 = wx.GetTextFromUser("Write the heading number from 1 to 6","html")
		h2 = wx.GetTextFromUser("Write the the words","html")
		if h1 =="1":
...
""")
	...
	def onp(self,event):
		p1 = wx.GetTextFromUser("write the paragraph","html")
		self.htmls.write(f"""<p>{p1}</p>
""")
	def onl(self,event):
		link1 = wx.GetTextFromUser("write the name of link","html")
		link2 = wx.GetTextFromUser("write the URL","html")
